 ...
 * Papers about accuracy: http://www.daemonology.net/papers/fft.pdf,
 * http://www.cs.berkeley.edu/~fateman/papers/fftvsothers.pdf For integers rounding works if $(|a| + |b|)\max(a, b) <
 * \mathtt{\sim} 10^9$, or in theory maybe $10^6$.
 */
